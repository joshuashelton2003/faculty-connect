...
export default function EnhancedRegister() {
  ...
  const [currentStep, setCurrentStep] = useState(
    roleParam ? steps.basicInfo : steps.roleSelection,
  );
  const [selectedRole, setSelectedRole] = useState<
    "faculty" | "employer" | null
  >(roleParam);
  ...
  const getStepTitle = (): string => {
    switch (currentStep) {
      case steps.roleSelection:
        return "Choose Your Role";
      case steps.basicInfo:
        return "Basic Information";
      case steps.additionalInfo:
        return selectedRole === "faculty"
          ? "Academic Details"
          : "Institution Details";
      case steps.verification:
        return "Profile Picture & Verification";
      default:
        return "";
    }
  };
      ...
      <div className="max-w-4xl mx-auto pt-4">
        ...
        <div className="text-center mb-10">
          <div className="flex justify-center mb-8">
            <div className="flex items-center space-x-3">
              ...
              />
              <div
                className="w-12 h-12 rounded-xl shadow-lg overflow-hidden"
                style={{ display: "none" }}
              >
                <img
                  src="https://cdn.builder.io/api/v1/image/assets%2Ff92995b2d56b4f0a8225b3c3ca0a3e61%2Fedeb625211be4bf3b33f96c0d13d421a?format=webp&width=200"
          ...
          <p className="text-lg text-slate-600 max-w-md mx-auto">
            Join thousands of educators and institutions on India's premier
            academic platform
          </p>
          ...
          <div className="mt-10 max-w-lg mx-auto">
            ...
            <div className="mt-4 text-lg font-semibold text-slate-700 tracking-wide">
              {getStepTitle()}
            </div>
          </div>
        </div>
        ...
        <Card className="bg-white shadow-2xl border-0 rounded-2xl overflow-hidden backdrop-blur-sm">
          <CardHeader className="pb-6 bg-gradient-to-r from-slate-50 to-blue-50 border-b border-slate-100">
            <CardTitle className="text-center text-2xl font-bold text-slate-800 tracking-wide">
              {getStepTitle()}
            </CardTitle>
          </CardHeader>
          <CardContent className="p-10 sm:p-12">
            <form onSubmit={handleSubmit(onSubmit)}>
              <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="text-center mb-10">
                      ...
                      <p className="text-slate-600 text-lg">
                        Choose your role to get started on your academic journey
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      >
                        ...
                        <p className="text-slate-600 leading-relaxed mb-4">
                          I'm an educator looking for teaching positions at
                          schools, colleges, and universities. I want to find
                          opportunities that match my expertise and career
                          goals.
                        </p>
                      ...
                      >
                        ...
                        <p className="text-slate-600 leading-relaxed mb-4">
                          I represent an educational institution and want to
                          post job openings, find qualified faculty members, and
                ...
                {currentStep === steps.additionalInfo &&
                    ...
                    >
                      <div className="text-center mb-6">
                        ...
                        <p className="text-gray-600">
                          Help us understand your academic background (optional)
                        </p>
                      </div>
                        ...
                        <div>
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="arts-science-college">
                              ...
                              <SelectItem value="research-institute">
                                Research Institute
                              </SelectItem>
                            </SelectContent>
                          </Select>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center space-y-4">
                      ...
                      <div className="text-center">
                        ...
                        <label
                          ...
                          className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-[#DDDAD0] cursor-pointer"
                        >
                    ...
                    <div className="bg-blue-50 rounded-lg p-6">
                      ...
                      <p className="text-sm text-blue-700 mt-4">
                        Click "Create Account" to complete your registration and
              ...
              <div className="flex justify-between mt-12 pt-8 border-t border-slate-200">
                ...
                {currentStep < steps.verification ? (
                  <Button
                    ...
                    onClick={nextStep}
                    disabled={
                      !selectedRole && currentStep === steps.roleSelection
                    }
