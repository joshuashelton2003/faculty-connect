...
import { productionCandidates, productionJobs, productionApplications, productionStats } from '@/data/productionSampleData\';onSampleData\';ampleData\';leData';
...
const CandidateDashboard: React.FC = () => {
  ...
  const candidateProfile = productionCandidates.find(c => c.email === user?.email) || productionCandidates[0];onCandidates[0];
